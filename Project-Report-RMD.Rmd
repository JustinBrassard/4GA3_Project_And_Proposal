...
```
The following section, Figure. \ref{fig:Col-SchoolZ} is similar to Figure. \ref{fig:Toronto}. Each variable has a symbol instead of strictly a color.The red symbol represents collisions, the black building represents schools, and the purple school signs represent speed signs or speed reduction zones. This map shows the same data stated previously, although the points are more distinctive due to the symbology and that they are on an actual map rather than a plot. 
