...
thanks: Paper submitted to complete the requirements of ENVSOCTY 4GA3 Applied Spatial
  Statistics.
author:
- name:__Michel Giese__
  student_number: 400010952
- name: __Justin Brassard__
  student_number: 400181410
- name: __Mohammad Ali__
  student_number: 400079555
- name: __Nathan Walschots__
...
```{r 2019-collision-hmap, echo=FALSE}
...
```{r Collisions-quadrat, echo=FALSE}
collisions.ppp <- as.ppp(st_coordinates(CollisionsPCS.sf), W = Toronto.owin)
Quadrat_Count_of_Collisions <- quadratcount(collisions.ppp, nx = 5, ny = 6)
plot(Quadrat_Count_of_Collisions)
Quadrat_Test_of_Collisions <- quadrat.test(collisions.ppp, nx = 5, ny = 6)
Quadrat_Test_of_Collisions
```

```{r Speed-Signs-quadrat, echo=FALSE}
speedsigns.ppp <- as.ppp(st_coordinates(School_ZonesPCS.sf), W = Toronto.owin)
Quadrat_Count_of_Speed_Signs <- quadratcount(speedsigns.ppp, nx = 5, ny = 6)
plot(Quadrat_Count_of_Speed_Signs)
Quadrat_Test_of_Speed_Signs <- quadrat.test(speedsigns.ppp, nx = 5, ny = 6)
Quadrat_Test_of_Speed_Signs
```

```{r Schools-quadrat, echo=FALSE}
Schools.ppp <- as.ppp(st_coordinates(SchoolsPCS.sf), W = Toronto.owin)
Quadrat_Count_of_Schools <- quadratcount(Schools.ppp, nx = 5, ny = 6)
plot(Quadrat_Count_of_Schools)
Quadrat_Test_of_Schools <- quadrat.test(Schools.ppp, nx = 5, ny = 6)
