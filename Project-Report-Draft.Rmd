...
```{r Quadrat_Test_Results, echo=FALSE, warning=FALSE, message=FALSE,table.cap={"\\label{tab:Quadrat_Test_Results}Quadrat Test Results for each Variable (2006-2019)"}}
...
```{r 0.1-total, echo=FALSE, warning=FALSE, message=FALSE, results=FALSE}
ggplot() +
