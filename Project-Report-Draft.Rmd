...
```{r GGPLOT1, echo=FALSE, fig.cap={"\\label{fig:Col-SchoolZ}Colliions, Schools and School Zones of Toronto, Canada (2021)"}}
ggplot() +
...
```{r leaflet1, echo=FALSE, fig.cap={"\\label{fig:Toronto-DATA}Leaflet of Collisions, Schools and School Zones Toronto, Canada (2021)"}}
