...
```{r 2019-collision-hmap, echo=FALSE, fig.cap={"\\label{fig:Heat Map1}Heat Map of Collisions with School Zones in Toronto, Canada (2006-2019)"}}
...
```{r kid-collisions-hmap, echo=FALSE, fig.cap={"\\label{fig:Heat Map2}Heat Map of Collisions People aged 0-19 in Toronto, Canada (2006-2019)"}}
...
A quadrat analysis was also done for each variable in order to create a count of each variable within a quadrat count of 25 tiles. Variable 1(Collisions) are shown in Figure. \ref{fig:Quadrat of Collisions}, Variable 2 (Speed Signs) are shown in Figure. \ref{fig:Quadrat of Speed Signs} and Variable 3 (Schools) are shown in Figure. \ref{fig:Quadrat of Schools}. This is beneficial to understand whether or not speed signs have an impact on the number of collisions that occur within school zones. 



```{r Collisions-quadrat, warning=FALSE, echo=FALSE,message=FALSE,results=FALSE,fig.cap={"\\label{fig:Quadrat of Collisions} Quadrat of collisions in Toronto, Canada (2006-2019)"}}
...
```{r Speed-Signs-quadrat, warning=FALSE, echo=FALSE,message=FALSE,results=FALSE, fig.cap={"\\label{fig:Quadrat of Speed Signs}Quadrat of Speed Signs in Toronto, Canada (2006-2019)"}}
...
```{r Schools-quadrat, warning=FALSE, echo=FALSE, message=FALSE, results=FALSE, fig.cap={"\\label{fig:Quadrat of Schools}Quadrat of Schools in Toronto, Canada (2006-2019)"}}
...
```{r 0.5-total, echo=FALSE, fig.cap={"\\label{fig:Buffer 500m} Collisions and speed signs within 500m of schools and Collisions with 500m of Speed signs in Toronto, Canada (2006-2019)"}}
ggplot() +
...
```{r 0.25-total, echo=FALSE,fig.cap={"\\label{fig:Buffer 250m} Collisions and speed signs within 250m of schools and Collisions with 250m of Speed signs in Toronto, Canada (2006-2019)"}}
ggplot() +
...
```{r 0.1-total, echo=FALSE, warning=FALSE, message=FALSE, results=FALSE,fig.cap={"\\label{fig:Buffer 100m} Collisions and speed signs within 100m of schools and Collisions with 100m of Speed signs in Toronto, Canada (2006-2019)"}}
ggplot() +
