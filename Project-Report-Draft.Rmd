...
Finally, buffers were created to analyze correlations at a more local scale, thus examining the data at set distance intervals. Figure. \ref{fig:fig:Buffer 500m} shows collisions (red) and speed signs (green) within 500m of schools and collisions within 500m of speed signs (black). Figure. \ref{fig:fig:Buffer 250m} and Figure. \ref{fig:fig:Buffer 100m} are similar, with buffers of 250m and 100m instead. 
