...
```{r Collisions-quadrat, warning=FALSE, echo=FALSE,message=FALSE,results=FALSE}
...
```{r Speed-Signs-quadrat, warning=FALSE, echo=FALSE,message=FALSE,results=FALSE}
...
```{r Schools-quadrat, warning=FALSE, echo=FALSE,message=FALSE,results=FALSE}
