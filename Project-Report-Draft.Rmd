...
```{r Collisions-quadrat, warning+FALSE, echo=FALSE}
...
```{r Speed-Signs-quadrat, warning=FALSE, echo=FALSE}
...
```{r Schools-quadrat, warning=FALSE, echo=FALSE}
...
```{r Quadrat_Test_Results, echo=FALSE, warning=FALSE, message=FALSE, results=FALSE, table.cap={"\\label{table:Quadrat_Test_Results}Quadrat Test Results for each Variable (2021)"}}
